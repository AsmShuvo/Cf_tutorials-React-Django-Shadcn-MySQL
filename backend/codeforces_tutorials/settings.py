"""
Django settings for codeforces_tutorials project.
...
SECRET_KEY = 'django-insecure-my*n9ehe9fk=6e%@-$u490@=g_!kwy@g=jqf3m5s7p&kq4y4g3'
...
WSGI_APPLICATION = 'codeforces_tutorials.wsgi.application'
